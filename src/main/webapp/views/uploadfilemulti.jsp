...
<head>
    <meta charset="UTF-8">
    <title>Upload File với @MultipartConfig</title>
    <style>
        ...
        .btn { width: 100%; padding: 14px; background: #3498db; color: white; border: none; border-radius: 8px; font-size: 16px; font-weight: 600; cursor: pointer; }
...
<body>
    <div class="container">
        <h2>📤 Upload File với @MultipartConfig</h2>
